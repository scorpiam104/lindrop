...
const storeThemes = [
  ['aurora', 'Aurora', 'Cyan glass and soft light'], ['minimal', 'Minimal', 'Clean space and sharp type'], ['noir', 'Noir', 'Dark luxury and contrast'], ['candy', 'Candy', 'Bright playful color'], ['editorial', 'Editorial', 'Magazine-inspired layout'], ['ocean', 'Ocean', 'Cool blue, calm and open'], ['sunset', 'Sunset', 'Warm coral and amber'], ['botanical', 'Botanical', 'Natural greens and cream'], ['mono', 'Mono', 'Black, white, and grid'], ['playful', 'Playful', 'Bold shapes and energy']
];
